          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            {filteredSkills.map((skill) => (
              <div 
                ...
                className="group bg-white border border-zinc-200 rounded-xl p-6 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-zinc-300 transition-all duration-300 flex flex-col h-full cursor-pointer"
              >
                ...
                <div className="mt-auto pt-4 border-t border-zinc-100">
                  ...
                  <div 
                    ...
                    onClick={(e) => { e.stopPropagation(); handleCopy(skill.id, skill.command); }}
                  >
